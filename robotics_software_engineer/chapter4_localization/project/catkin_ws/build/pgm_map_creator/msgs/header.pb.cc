...
constexpr Header::Header(
  ...
  : str_id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , stamp_(nullptr)
  , index_(0){}
...
const uint32_t TableStruct_header_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Header, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Header, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Header, str_id_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Header, stamp_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Header, index_),
  0,
  1,
  2,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::gazebo::msgs::Header)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::gazebo::msgs::_Header_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_header_2eproto = {
  false, false, 114, descriptor_table_protodef_header_2eproto, "header.proto", 
...
class Header::_Internal {
 public:
  ...
  static void set_has_str_id(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static const ::gazebo::msgs::Time& stamp(const Header* msg);
...
Header::Header(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:gazebo.msgs.Header)
}
Header::Header(const Header& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  str_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    str_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_str_id()) {
    str_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_str_id(), 
...
inline void Header::SharedDtor() {
  ...
  str_id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:gazebo.msgs.Header)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      str_id_.ClearNonDefaultToEmpty();
    }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_str_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "gazebo.msgs.Header.str_id");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Header::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_str_id().data(), static_cast<int>(this->_internal_str_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "gazebo.msgs.Header.str_id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_str_id(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:gazebo.msgs.Header)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_str_id(from._internal_str_id());
    }
    if (cached_has_bits & 0x00000002u) {
...
void Header::InternalSwap(Header* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &str_id_, lhs_arena,
      &other->str_id_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Header, index_)
      + sizeof(Header::index_)
...
template<> PROTOBUF_NOINLINE ::gazebo::msgs::Header* Arena::CreateMaybeMessage< ::gazebo::msgs::Header >(Arena* arena) {
  return Arena::CreateMessageInternal< ::gazebo::msgs::Header >(arena);
}
