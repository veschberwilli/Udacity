...
echo_and_run cd "/lhome/micmink/fad/repos/github/udacity_robotics/chapter6_path_planning/home_service_robot/catkin_ws/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/lhome/micmink/fad/repos/github/udacity_robotics/chapter6_path_planning/home_service_robot/catkin_ws/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/lhome/micmink/fad/repos/github/udacity_robotics/chapter6_path_planning/home_service_robot/catkin_ws/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
